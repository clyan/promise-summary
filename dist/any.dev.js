...
var _require = require("./util"),
    ...
    asyncRejectedTask = _require.asyncRejectedTask; // 核心：有一个成功就成功
...
var rejectPromiseAll = Promise.any([asyncRejectedTask(2, 2000), asyncRejectedTask(3, 1000), asyncRejectedTask(4, 3000)]);
